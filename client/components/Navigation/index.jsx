export default function Navigation(props) {
  return (
    <header
      ...
      data-ga4-event-tracker-module-started="true"
    ...
    >
      <div className="gem-c-layout-super-navigation-header__container govuk-clearfix">
          ...
          <div className="gem-c-layout-super-navigation-header__header-logo">
            ...
            >
              <span className="govuk-header__logotype">
                ...
                <span className="govuk-header__logotype-text">data.gov.uk</span>
              </span>
            </a>
          </div>
        </div>
        <nav
          ...
          className="gem-c-layout-super-navigation-header__content js-module-initialised"
          data-module="super-navigation-mega-menu"
          data-super-navigation-mega-menu-module-started="true"
        >
          <h2
            id="super-navigation-menu-heading"
            className="govuk-visually-hidden"
          >
            Navigation menu
          </h2>

          <div className="govuk-width-container gem-c-layout-super-navigation-header__button-width-container">
            <div className="gem-c-layout-super-navigation-header__button-container">
              <div className="gem-c-layout-super-navigation-header__navigation-item">
                <a
                  ...
                  data-track-action="menuLink"
                  data-track-category="headerClicked"
                  data-track-label="/browse"
                  data-track-dimension="Menu"
                  data-track-dimension-index="29"
                  href="/browse"
                  hidden="hidden"
                >
                  <span className="gem-c-layout-super-navigation-header__navigation-item-link-inner">
                    Menu
                  </span>
                </a>
                <button
                  aria-controls="super-navigation-menu-df5e0249"
                  aria-expanded="false"
                  ...
                  data-ga4-event='{"event_name":"select_content","type":"header menu bar","text":"Menu","index":1,"index_total":2,"section":"Menu"}'
                  id="super-navigation-menu-df5e0249-toggle"
                  type="button"
                >
              ...
              <div className="gem-c-layout-super-navigation-header__search-item">
                <button
                  ...
                  type="button"
                  data-ga4-event='{"event_name":"select_content","type":"header menu bar","text":"Search","index":2,"index_total":2,"section":"Search"}'
                >
